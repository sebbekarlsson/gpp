...
void test_inputs() {
  {
    ...
    gpp_result_T *res =
        gpp_eval(gpp_read_file("inputs/hello-world.html"), 0, 0, 0);
...

  {
    ...
    gpp_result_T *res =
        gpp_eval(gpp_read_file("inputs/arrow-function.html"), 0, 0, 0);
    test_assert(!!res->res, "res->res exists");
...

  {
    ...
    gpp_result_T *res =
        gpp_eval(gpp_read_file("inputs/map-context.html"), 0, 0, 0);
    test_assert(!!res->res, "res->res exists");
