...
void test_inputs()
{
...

    {
      ...
      gpp_result_T* res = gpp_eval(gpp_read_file("inputs/map-context.html"), 0, 0, 0);
      test_assert(!!res->res, "res->res exists");
      test_assert(strcmp(res->res,
"<li>Not</li>\n"
"<li>Made</li>\n"
"<li>with</li>\n"
"<li>Coffee</li>\n"
...
"<li>San</li>\n"
"<li>Francisco</li>\n"            
      ) == 0, "Receives correct output");
    }

    {
      printf("Running test: escape.html\n");
      gpp_result_T* res = gpp_eval(gpp_read_file("inputs/escape.html"), 0, 0, 0);
      test_assert(!!res->res, "res->res exists");
      test_assert(strcmp(res->res, "&lt;h1&gt;Hello&lt;/h1&gt;") == 0, "Receives correct output");
    }
}
